      ...
      <div class="track-item mb-2">
        ...
        <div class="row">
          ...
          <div class="col-2 col-lg-2 text-end">
            <div class="d-grid">
              <button  wire:click="btnToSend('{{ $track->code }}')" type="button" wire:loading.attr="disabled" class="btn btn-primary btn-lg"><i class="bi bi-send"></i> <span class="d-none d-sm-inline">To send</span></button>
            </div>
          </div>
        </div>
      </div>
