<div>
  ...
  <div class="container">
    ...
    <ul class="nav nav-tabs mb-3">
      ...
      <li class="nav-item">
        <a class="nav-link bg-light active" aria-current="page">Arrival</a>
      </li>
    </ul>
    ...
    <div class="row">
      <div class="col-12 col-sm-3 mb-2">
        <form wire:submit.prevent="toArrive">
          ...
          <button type="submit" id="toArrive" wire:loading.attr="disabled" class="btn btn-primary btn-lg mb-2"><i class="bi bi-check2-all"></i> To arrive</button>
        </form>
